...
public class OrderDomainServiceImpl implements OrderDomainService {
    ...
    public OrderCreatedEvent validateAndInitiateOrder(Order order, Restaurant restaurant) {
        ...
        log.info("Order whit id: {} is initiated", order.getId().getValue());
    ...
    public OrderPaidEvent payOrder(Order order) {
        order.pay();
        log.info("Order whit id: {} is paid", order.getId().getValue());
    ...
    public void approveOrder(Order order) {
        order.approved();
        log.info("Order whit id: {} is approved", order.getId().getValue());
    }

    @Override
    public OrderCancelledEvent cancelOrderPayment(Order order, List<String> failureMessages) {
        order.initCancel(failureMessages);
        log.info("Order payment is cancelling for order whit id: {}", order.getId().getValue());
    ...
    public void cancelOrder(Order order, List<String> failureMessages) {
        ...
        log.info("Order whit id: {} is canceled", order.getId().getValue());
    }
