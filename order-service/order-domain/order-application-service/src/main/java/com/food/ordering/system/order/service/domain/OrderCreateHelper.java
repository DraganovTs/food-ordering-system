...
import com.food.ordering.system.order.system.domain.entity.Customer;
...
public class OrderCreateHelper {
    ...
    public OrderCreatedEvent persistOrder(CreateOrderCommand createOrderCommand){
        ...
        saveOrder(order);
        log.info("Order is created whit id: {} ",orderCreatedEvent.getOrder().getId().getValue());
    ...
    private Restaurant checkRestaurant(CreateOrderCommand createOrderCommand) {
        ...
        if (optionalRestaurant.isEmpty()) {
            log.warn("Could not find restaurant whit restaurant id: {}", createOrderCommand.getRestaurantId());
            throw new OrderDomainException("Could not find restaurant whit restaurant id: " + createOrderCommand.getRestaurantId());
        }
    ...
    private void checkCustomer(UUID customerId) {
        ...
        if (customer.isEmpty()) {
            ...
            throw new OrderDomainException("Could not find customer whit customer id: " + customer);
        }
    }
    ...
    private Order saveOrder(Order order) {
        ...
        log.info("Order is saved whit id: {}", orderResult.getId().getValue());
        return orderResult;
    }
