...
import static com.food.ordering.system.order.system.domain.entity.Order.FAILURE_MESSAGE_DELIMITER;
        ...
        messages.forEach(restaurantApprovalResponseAvroModel -> {
            try {
                if (OrderApprovalStatus.APPROVED == restaurantApprovalResponseAvroModel.getOrderApprovalStatus()){
                    ...
                    log.info("Processing rejected order for order idL {}. whit failure messages: {}",
