...
public class PaymentDomainServiceImpl implements PaymentDomainService {
    ...
    private void validateCreditEntry(Payment payment, CreditEntry creditEntry, List<String> failureMessages) {
        if (payment.getPrice().isGreaterThan(creditEntry.getTotalCreditAmount())) {
            log.error("Customer whit id: {} doesn't have enough credit for payment!",
                    payment.getCustomerId().getValue());
            failureMessages.add("Customer whit id=" + payment.getCustomerId().getValue()
    ...
    private void validateCreditHistory(CreditEntry creditEntry,
        ...
        if (totalDebitHistory.isGreaterThan(totalCreditHistory)) {
            log.error("Customer whit id: {} doesn't have enough credit according to credit history",
                    creditEntry.getCustomerId().getValue());
            failureMessages.add("Customer whit id=" + creditEntry.getCustomerId().getValue() +
